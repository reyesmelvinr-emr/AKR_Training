...
│   ├── table_doc_template.md                    ← Database table template
...
│   ├── Table_Documentation_Developer_Guide.md   ← Database table developer guide
...
│   └── Table_Documentation_Developer_Guide.md
│
...
2. **Move files to new structure**:
   ...
   Copy-Item "AKR files\Table_Documentation_Developer_Guide.md" "guides\" -Force
